...
function filterCards(query) {
    const cards = document.querySelectorAll("#view-catalog .opportunity-card, #view-home .opportunity-card");
    cards.forEach(card => {
